...
* Filename of files inside the folders represent component name, e.g. `Customer.yaml` and also try to do some other stuff... also making a PR request that is maybe valid
